...
import 'package:flutterlearniti/allapppages/appscreans/readbook.dart';
...
//  List<Chapter> chapters = [];
  ...
  void _loadAuthorInfo() {
    ...
    setState(() {
      authorBio =
          '${widget.book.authors[0]} is a renowned author in the ${widget.book.category.toLowerCase()} genre. '
  ...
  void _startReading() {
    ...
    context.read<BooksProvider>().selectBook(widget.book.id);
    Navigator.push(
  context,
  MaterialPageRoute(
    builder: (_) => BookReaderPage(book:  widget.book),
  ),
);
  }
                      ...
                      CircleAvatar(
                        ...
                        child: Text(
                          widget.book.authors.isNotEmpty
                              ? widget.book.authors[0][0].toUpperCase()
                              : 'A',
                          style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
